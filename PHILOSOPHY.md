...
3. Simple mental model (numbered experiments, flexible ID resolution)
...
- Experiments are full clones including .git — accidental push risk accepted, user responsibility
